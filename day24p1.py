...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 25 22:53:11 2023
...
# 
# hailstones = [Hailstone(*map(int, line.replace("@", ",").split(","))) for line in open("day24p1.txt")]
# 
# total = 0
# 
...
hailstones = [tuple(map(int, line.replace("@", ",").split(","))) for line in open("day24p1.txt")]
